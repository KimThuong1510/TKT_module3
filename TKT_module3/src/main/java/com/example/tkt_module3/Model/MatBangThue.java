package com.example.tkt_module3.Model;
...
public class MatBangThue{
    ...
    public MatBangThue(String maMb, double dienTich, int trThai, int tang, int loaiVp, double giaThue, Date startDate, Date endDate) {
        this.maMb = maMb;
